...
public class AuthenticationService {
	...
	public boolean changePassword(SystemUser user, Password oldPassword, Password newPassword) throws DataConcurrencyException, DataIntegrityViolationException {
	...
	public String resetPassword(SystemUser user) throws DataConcurrencyException, DataIntegrityViolationException {
		final String token = user.resetPassword();
		repo.save(user);
		return token;
	}

	public boolean resetPassword(SystemUser user, String token) throws DataConcurrencyException, DataIntegrityViolationException {
